...
public sealed class TabularRenderingTests : IAsyncLifetime, IDisposable
{
    ...
    /// <summary>
    /// Pull the user-visible prose text out of a multi-content <see cref="CallToolResult"/>:
    /// the first <see cref="TextContentBlock"/> whose annotations don't restrict it to
    /// <see cref="Role.Assistant"/> only. The trailing audience-restricted metadata block is
    /// skipped so substring assertions can pin the substantive prose without competing with
    /// the per-call `_meta:` line.
    /// </summary>
    ...
    public async Task FindReferences_multipleHits_rendersTable()
    {
        ...
        var output = ProseText(await GraphTools.FindReferencesAsync(_router!, "Calculator.Add"));
    ...
    public async Task SearchSymbols_multipleHits_rendersTable()
    {
        ...
        var output = ProseText(await GraphTools.SearchSymbolsAsync(_router!, "Add"));
    ...
    public async Task FindByAnnotation_multipleHits_rendersTable()
    {
        ...
        var output = ProseText(await GraphTools.FindByAnnotationAsync(_router!, "Obsolete"));
    ...
    public async Task ListCallers_multipleHits_rendersTable()
    {
        ...
        var output = ProseText(await GraphTools.ListCallersAsync(_router!, "Calculator.Add"));
    ...
    public async Task ListCallees_multipleHits_rendersTable()
    {
        ...
        var output = ProseText(await GraphTools.ListCalleesAsync(_router!, "Sample.Domain.Greeter.Greet"));
    ...
    public async Task FindImplementations_multipleHits_rendersTable_orFallsBackToBullet()
    {
        ...
        var output = ProseText(await GraphTools.FindImplementationsAsync(_router!, "IGreeter.Greet"));
    ...
    public async Task ListMembers_multipleHits_rendersTable()
    {
        ...
        var output = ProseText(await GraphTools.ListMembersAsync(_router!, "Sample.Domain.Calculator"));
    ...
    public async Task FindDiagnostics_multipleHits_rendersTable_orFallsBackToBulletWhenSingle()
    {
        ...
        var output = ProseText(await GraphTools.FindDiagnosticsAsync(_router!));
    ...
    public async Task ListTestsFor_multipleHits_rendersTable()
    {
        ...
        var output = ProseText(await HistoryTools.ListTestsForAsync(_router!, "Calculator.Add"));
    ...
    public async Task ImpactOfChange_multipleHits_rendersTableWithRightAlignedDepth()
    {
        ...
        var output = ProseText(await GraphTools.ImpactOfChangeAsync(_router!, "Calculator.Add"));
    ...
    public async Task ModuleSummary_multipleHits_rendersTableWithRightAlignedInDeg()
    {
        ...
        var output = ProseText(await GraphTools.ModuleSummaryAsync(_router!, "Sample.Domain"));
    ...
    public async Task Neighborhood_multipleInbound_rendersTable()
    {
        ...
        var output = ProseText(await GraphTools.NeighborhoodAsync(_router!, "Calculator.Add"));
    ...
    public async Task SemanticSearch_disabledStore_returnsLeadInProse()
    {
        ...
        var output = ProseText(await GraphTools.SemanticSearchAsync(_router!, generator, "calculator add"));
        var firstLine = output.Split('\n')[0];
    ...
    public async Task RecentChanges_multipleHits_rendersTable()
    {
        ...
        var output = ProseText(await HistoryTools.RecentChangesAsync(_router!, options, days: 7));
